...
#define ODPG_ENABLE_REG			       0x100d4


CMV88F6281ODPGConfigStrategy::CMV88F6281ODPGConfigStrategy(CODPGHwModule *pODPG):CIODPGConfigStrategy(pODPG)
{
	m_sDevName			= "MV88F6281";
	m_sDevBusWidth      = "16";
...
CMV88F6281ODPGConfigStrategy::~CMV88F6281ODPGConfigStrategy(void)
{

}


BOOL    CMV88F6281ODPGConfigStrategy::InitODPG()
{
...
BOOL    CMV88F6281ODPGConfigStrategy::StartODPG()
{	
	UINT	nVal;
...
BOOL    CMV88F6281ODPGConfigStrategy::StopODPG()
{	
	UINT	nVal;
